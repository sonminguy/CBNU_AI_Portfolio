...
import torch
from dust3r.cloud_opt.commons import compute_edge_scores, edge_str, i_j_ij
from dust3r.post_process import estimate_focal_knowing_depth
from dust3r.utils.geometry import geotrf, get_med_dist_between_poses, inv
...
def init_from_pts3d(self, pts3d, im_focals, im_poses):
    ...
    if self.has_im_poses:
        ...
        if self.same_focals:
            self._set_focal(
                0, torch.tensor(im_focals).mean()
            )  # initialize with mean focal
